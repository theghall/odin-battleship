...
test('it should create a ship with the correct name', () => {
  const aBattleship = battleship.createShip('Battleship', battleship.hulls.battleship);

  expect(aBattleship.getName()).toMatch('Battleship');
});

test('it should create a ship with the correct hull length', () => {
  const aBattleship = battleship.createShip('Battleship', battleship.hulls.battleship);

  expect(aBattleship.getLength()).toBe(battleship.hulls.battleship);
});
